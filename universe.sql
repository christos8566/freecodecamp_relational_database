...
INSERT INTO public.planet VALUES (1, 'Venus', 6052, 0.815, 108, 1, 0, 'Thick and Toxic', 'Rocky', false);
INSERT INTO public.planet VALUES (8, 'Mercury', 4878, 0.055, 4.88, 1, 0, 'Very Thin', 'Rocky', false);
INSERT INTO public.planet VALUES (11, 'LHS 1678 d', NULL, 0.907, 6, 2, 0, NULL, 'Rocky', false);
INSERT INTO public.planet VALUES (12, 'Kepler-186f', 15000, 1.1, 59.5, 11, 0, 'Nitrogen and Oxygen', 'Rocky', false);
INSERT INTO public.planet VALUES (2, 'Earth', 6371, 1, 149.7, 1, 1, 'Nitrogen and Oxygen', 'Diverse', true);
INSERT INTO public.planet VALUES (3, 'Mars', 3390, 0.11, 227.9, 1, 2, 'Thin', 'Rocky', true);
INSERT INTO public.planet VALUES (4, 'Jupiter', 69911, 318, 778, 1, 79, 'Thick', 'Gas', true);
INSERT INTO public.planet VALUES (5, 'Uranus', 15759, 14.5, 2900, 1, 27, 'Thick', 'Gas', true);
INSERT INTO public.planet VALUES (6, 'Pluto', 2376, 0.002, 5900, 1, 5, 'Thin', 'Rocky', true);
INSERT INTO public.planet VALUES (7, 'Eris', 2326, 0.0025, 10000, 1, 1, 'Very Thin', 'Rocky', true);
INSERT INTO public.planet VALUES (9, 'Neptune', 48682, 17.1, 4500, 1, 14, 'Thick', 'Gas', true);
INSERT INTO public.planet VALUES (10, 'Saturn', 58232, 95, 1400, 1, 83, 'Thick', 'Gas', true);
...
INSERT INTO public.resource VALUES (1, 'Water', 'Liquid', 'Drinking', 'Argiculture Aquifer, Extraction', true);
INSERT INTO public.resource VALUES (2, 'Iron', 'Metal', 'Fuel', 'Mining, Smelting', false);
INSERT INTO public.resource VALUES (3, 'Helium', 'Gas', 'Cooling', 'Gas extraction, Refining', false);
INSERT INTO public.resource VALUES (4, 'Silicon', 'Mineral', 'Electronics', 'Mining, Smelting', false);
INSERT INTO public.resource VALUES (5, 'Uranium', 'Mineral', 'Nuclear energy', 'Mining, Enrichment', false);
INSERT INTO public.resource VALUES (6, 'Methane', 'Gas', 'Fuel, Energy', 'Gas extraction, Drilling', false);
INSERT INTO public.resource VALUES (7, 'Gold', 'Metal', 'Jewerly, Refigeration', 'Synthesis from nitrogen and hydrogen', true);
...
INSERT INTO public.star VALUES (1, 'Sun', 'Center', 0, 4.83, 'G2V', 0, 1.0000, 1, 1, 5778, 4600, 1);
INSERT INTO public.star VALUES (2, 'Polaris', 'Ursa Minor', 89.15, -3.64, 'F7lb', 433, 37.5000, 5.4, 2500, 6015, 70, 1);
INSERT INTO public.star VALUES (3, 'Sirius', 'Canis Major', -16.42, 1.42, 'A1V', 8.6, 1.7100, 2.02, 25.4, 9940, 250, 1);
INSERT INTO public.star VALUES (4, 'Alpha Centauri', 'Centaurus', -60.5, 4.38, 'G2V', 4.37, 1.2200, 1.1, 1.5, 5790, 5000, 1);
INSERT INTO public.star VALUES (5, 'Betelgeuse', 'Orion', 7.24, -5.85, 'M1-2la-lab', 642.5, 764.0000, 18, 126000, 3500, 9, 1);
INSERT INTO public.star VALUES (6, 'Rigel', 'Orion', -8.12, -6.7, 'B8la', 860, 79.0000, 21, 120000, 11500, 8, 1);
INSERT INTO public.star VALUES (7, 'Vega', 'Lyra', 38.47, 0.58, 'A0V', 25.04, 2.3620, 2.1, 40.12, 9602, 455, 1);
INSERT INTO public.star VALUES (8, 'Canopus', 'Carina', -52.42, -5.53, 'A9ll', 310, 71.0000, 8, 10700, 7350, 10, 1);
INSERT INTO public.star VALUES (9, 'Gliese784', 'Telescopium', -23.5, 9.42, 'MOV', 19.28, 0.5600, 0.58, 0.08, 3880, NULL, 1);
INSERT INTO public.star VALUES (10, 'Nembus', 'Andromeda', 42.34, -0.2, 'K3ll', 173, 21.3000, 1.8, 142, 4300, NULL, 2);
INSERT INTO public.star VALUES (11, 'Kepler-186', 'Cygnus', 50.3, 8.5, 'K1V (K-dwarf)', 500, 0.6000, 0.55, 0.18, 4800, 4500, 1);
...
SELECT pg_catalog.setval('public.recource_resource_id_seq', 7, true);
